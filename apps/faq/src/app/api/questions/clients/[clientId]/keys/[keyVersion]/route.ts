...
import { deleteOuterClientKey } from '@/server/outer-clients/service';
import { outerClientKeyParamSchema } from '../../../schema';
...
function internalServerError(error: unknown) {
  console.error('Question client key delete route error:', error);
  return NextResponse.json(
    {
...
export async function DELETE(req: NextRequest, context: RouteContext) {
  try {
    ...
    await deleteOuterClientKey(clientId, keyVersion);
